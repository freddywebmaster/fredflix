      ...
      if (authType === "register") {
        ...
        if (result?._id) {
          ...
          if (process.env.NODE_ENV === "production") {
            ...
            const msg = {
              to: email,
              from: "fwebmaster.gt@gmail.com",
              subject: "Email verification link from FredFlix",
              text: "Click the button below to verify your account",
              html: `<div style='text-align:center;position:relative; width:400px;padding:40px;margin:0 auto;background-color:black;color:white;font-family:Helvetica, sans-serif'><h1>Hi ${username},</h1><br/><br/><p style="color:white;font-size:1.1rem">You have successfully created a FredFlix account.<br/>Please click on the link below to verify your email address and complete your registration.</p><br/><br/><a style='display:inline-block;text-decoration:none;background-color:#e50914;padding:15px;color:white;border-radius:5px;font-weight:bold;font-size:1.4rem;font-family:Helvetica, sans-serif;' href="https://fredflix-gt.netlify.app/user/verify/${token}" rel="noreferrer">Verify your email</a><br/><br/><p>If that doesn't work, copy and paste the following link in your browser:<br/><br/>https://fredflix-gt.netlify.app/user/verify/${token}</p></div></div>`,
            };
            sgMail
              .send(msg)
              .then(() => {
